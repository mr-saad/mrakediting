...
const Footer = () => {
  return (
    <footer className="text-center bg-dark text-light position-relative">
      <svg
        style={{ zIndex: -1 }}
      ...
      <div className="d-flex align-items-center flex-column gap-2">
        ...
        >
          <FaPhoneAlt color="#fff" className="me-2" size={20} /> : 9265749251
          [MR AYAN KHATRI]
        </a>
        <a
          ...
          className="text-light d-flex align-items-center text-decoration-none"
        >
          <MdEmail color="#fff" className="me-2" size={20} /> :
        ...
        <a
          ...
          className="text-light d-flex align-items-center text-decoration-none"
        >
          <IoLogoWhatsapp color="#fff" className="me-2" size={20} /> :
          9265749251
        </a>
      </div>
